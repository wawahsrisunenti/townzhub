                        ...
                        <div class="col-lg-12">
                            <div class="title-inner style">
                                <div class="title-group fs-12"><a class="home fw-6 text-color-3"
                                        href="{{ route('index') }}">Home</a><span>About</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-7">
                            <div class="heading-about">
                                ...
                                <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Egestas vitae auctor in
                                    gravida tellus vestibulum faucibus in ut. Dolor bibendum suspendisse vestibulum
                                    ullamcorper morbi morbi vulputate.</h4>
                                <p class="text-1 text-color-2">Donec bibendum nibh quis nisl luctus, at aliquet ipsum
                                    bibendum. Fusce at dui tincidunt nulla semper venenatis at et magna. Mauris turpis
                                    lorem, ultricies vel justo sed, ultrices auctor nisi. </p>
                                <div class="text-box">
                                    <p class="font-2 fw-5 font-italic text-color-2">Lorem ipsum dolor sit amet,
                                        consectetur adipiscing elit. Suspendisse auctor, mi euismod dignissim
                                        scelerisque, eros augue vehicula lectus, quis vestibulum enim augue ut est</p>
                                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="wrap-why-choose flex">
                                <div class="box center hv-one">
                                    ...
                                    <div class="images img-style relative"><img
                                            src="assets/images/img-box/why-choose-1.jpg" alt="images"></div>
                                    <p class="text-color-2">The lists are always refreshed and updated constantly, you
                                        will never miss</p>
                                    <div class="meta style">
                                        <a href="#"
                                            class="btn-button flex align-center justify-center fs-13 fw-6 text-color-2"><span>See
                                                all listings</span>
                                ...
                                <div class="box center hv-one">
                                    ...
                                    <div class="images img-style relative"><img
                                            src="assets/images/img-box/why-choose-2.jpg" alt="images"></div>
                                    <p class="text-color-2">Find the right house for you in the shortest amount of time
                                    </p>
                                    <div class="meta style">
                                        <a href="#"
                                            class="btn-button flex align-center justify-center fs-13 fw-6 text-color-2"><span>See
                                ...
                                <div class="box center hv-one">
                                    ...
                                    <div class="images img-style relative"><img
                                            src="assets/images/img-box/why-choose-3.jpg" alt="images"></div>
            ...
            <section class="flat-search-home page">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2 class="fw-8 font-2 lh-56">We provide the most suitable and quality real estate.
                                </h2>
                                <p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed
                                ...
                                <div class="icon relative flex-none">
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#fff" stroke="white" stroke-width="0.4" />
                                        <path
                            ...
                            <div class="box-icon flex align-center">
                                ...
                                <div class="content">
                                    ...
                                    <a href="tel:0123456789">
                                        <div class="fs-30 fw-7">314-555-0123</div>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-icon flex align-center">
                                <div class="icon relative flex-none">
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_1505_28697)">
                                            <path
                                                d="M36.6559 17.8341L36.6559 17.8341L36.6609 17.8392C36.8315 18.0113 37.0549 18.0969 37.2788 18.0969C37.5021 18.0969 37.7258 18.0116 37.8976 17.8411C38.2409 17.5005 38.241 16.9425 37.8996 16.5985C37.5586 16.2548 37.0037 16.2526 36.66 16.5934L36.6559 17.8341ZM36.6559 17.8341L36.6551 17.8332M36.6559 17.8341L36.6551 17.8332M36.6551 17.8332C36.3141 17.4895 36.3163 16.9345 36.66 16.5935L36.6551 17.8332Z"
                                                fill="#fff" stroke="white" stroke-width="0.2" />
                                            <path
                                                d="M46.4639 27.8825H46.7054L46.5346 27.7118L39.3343 20.5115C38.992 20.1691 38.992 19.6141 39.3343 19.2718C39.6767 18.9296 40.2317 18.9296 40.574 19.2718L49.6441 28.3419C49.8085 28.5063 49.9009 28.7294 49.901 28.9618C49.901 29.1943 49.8086 29.4172 49.6442 29.5816L34.0757 45.1502C33.9114 45.3145 33.6884 45.4069 33.4559 45.4069C33.2235 45.4069 33.0005 45.3145 32.8361 45.1502L9.34306 21.6572C9.34306 21.6572 9.34305 21.6572 9.34305 21.6572C9.00075 21.3148 9.00076 20.7598 9.34305 20.4175L24.9114 4.84884C25.2537 4.50664 25.8087 4.50664 26.151 4.84884C26.151 4.84884 26.151 4.84884 26.1511 4.84884L34.9723 13.67C35.3146 14.0124 35.3146 14.5675 34.9723 14.9098C34.6299 15.252 34.0749 15.2519 33.7326 14.9098L26.7811 7.95839L26.6104 7.78768V8.0291V25.1994C26.6104 26.679 27.8139 27.8825 29.2935 27.8825H46.4639ZM24.8575 7.62373V7.38231L24.6868 7.55302L12.2497 19.9901L12.079 20.1608H12.3204H24.7575H24.8575V20.0608V7.62373ZM32.4087 42.2434L32.5794 42.4141V42.1727V29.7356V29.6356H32.4794H29.2937C26.8477 29.6356 24.8575 27.6455 24.8575 25.1994V22.0139V21.9139H24.7575H12.3204H12.079L12.2497 22.0846L32.4087 42.2434ZM34.3324 42.1728V42.4142L34.5031 42.2435L46.9401 29.8064L47.1108 29.6356H46.8694H34.4324H34.3324V29.7356V42.1728Z"
                                                fill="#fff" stroke="white" stroke-width="0.2" />
                                            <path
                                ...
                                <div class="content">
                                    ...
                                    <a href="mailto:hellosupport@gmail.com">
                                        <div class="fs-16">hellosupport@gmail.com</div>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="{{ route('agentsDetail') }}"><img src="assets/images/img-box/meet-4.jpg"
                                            alt="images"></a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="{{ route('agentsDetail') }}"><img src="assets/images/img-box/meet-5.jpg"
                                            alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="{{ route('agentsDetail') }}"><img src="assets/images/img-box/meet-6.jpg"
                                            alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="title-bottom center"> Copyright © 2024. Designed & Developed by <a
                                    href="https://dcliq.co.id" class="text-color-1">TOWNZHUB</a> </div>
                        </div>
                    </div>
                </div>
            </div>

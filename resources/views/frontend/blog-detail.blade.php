            ...
            <section class="flat-blog-detail flat-property-detail">
                <div class="container">
                    <div class="row flex">
                        <div class="col-lg-8">
                            <div class="post">
                                <div class="title-heading fs-30 fw-7 lh-45">Lack of home listings is taking a toll on
                                    mortgage demand</div>
                                ...
                                <div class="texts-1 fs-16 fw-8 font-2 lh-29">Mortgage rates fell last week, but demand
                                    for home loans didn’t move higher as a result. Other aspects of today’s housing
                                    market are outweighing the benefit of lower mortgage rates right now, namely a lack
                                    of supply.</div>
                                <div class="image"><img src="assets/images/img-box/blog-detail.jpg" alt="images">
                                </div>
                                <div class="content-img">
                                    <div class="sub-title fs-12 fw-6">A “For Sale” sign outside a house in Albany,
                                        California, on Tuesday, May 31, 2022.</div>
                                    <div class="fs-12 fw-4">David Paul Morris | Bloomberg | Getty Images</div>
                                </div>
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">The average contract interest rate
                                    for 30-year fixed-rate mortgages with conforming loan balances ($726,200 or less)
                                    decreased to 6.40% from 6.45%, with points falling to 0.59 from 0.62 (including the
                                    origination fee) for
                                    loans with a 20% down payment. It had been over 7% just a month ago.</p>
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">Mortgage applications to purchase a
                                    home, however, dropped 4% last week compared with the previous week, according to
                                    the Mortgage Bankers Association’s seasonally adjusted index. Demand was 35% lower
                                    than the same week
                                    one year ago.</p>
                                <div class="text-box">
                                    <p class="texts fs-16 font-2 lh-29 text-color-2">“Spring has arrived, but the
                                        housing market is missing the customary burst in listings and purchase activity
                                        that typically mark the season. After four weeks of increasing purchase
                                        application activity, volume declined
                                        a bit this week even with another small drop in mortgage rates,” said Mike
                                        Fratantoni, MBA’s chief economist.</p>
                                </div>
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">New listings were down 20% year over
                                    year in March, according to Realtor.com, and total inventory was about half of what
                                    it was in March 2019, pre-Covid pandemic.</p>
                                <div class="text-box">
                                    <p class="texts fs-16 font-2 lh-29 text-color-2 fw-6">“Although the mortgage rate
                                        for conforming balance loans declined by five basis points over the week to
                                        6.40%, the mortgage rate for jumbo loans increased by nine basis points to
                                        6.36%,” added Fratantoni. “While we
                                        have seen relative weakness at the high end of the housing market in recent
                                        months, the divergence in rates suggests that banks may be tightening credit in
                                        response to recent challenges, preserving balance sheet
                                        capacity as deposit balances have declined.”</p>
                                </div>
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">Most jumbo loans are held on bank
                                    balance sheets.</p>
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">Demand for Federal Housing
                                    Administration and Department of Veterans Affairs loans, which are favored by
                                    lower-income borrowers due to low down payment requirements, declined more than
                                    those for conventional loans. While
                                    there is strong demand from first-time homebuyers, with millennials hitting their
                                    peak buying age, affordability is still a challenge right now.</p>
                                <p class="texts-3 fs-16 font-2 lh-29 text-color-2">Applications to refinance a home
                                    loan also dropped, down 5% for the week and 59% lower than the same week a year ago.
                                    The refinance share of mortgage activity decreased to 28.6% of total applications
                                    from 29.1% the previous
                                    week. Rates are 150 basis points higher than they were at the same time last year,
                                    so there are precious few borrowers who can now benefit from a refinance.</p>
                                        ...
                                        <ol class="">
                                            <li class="flex">
                                                <div class="images flex-none">
                                                    <img src="assets/images/author/author-review-1.jpg"
                                                        alt="images">
                                                </div>
                                                <div class="content">
                                                    ...
                                                    <p class="texts text-color-2">Lorem ipsum dolor sit amet,
                                                        consectetur adipiscing elit. Pellentesque at velit eu libero
                                                        laoreet mattis ac a ipsum. Vivamus efficitur volutpat ante, sed
                                                        consequat ligula ultricies in.</p>
                                                    <div class="img-box">
                                            ...
                                            <li class="flex">
                                                <div class="images flex-none">
                                                    <img src="assets/images/author/author-review-2.jpg"
                                                        alt="images">
                                                </div>
                                                <div class="content">
                                                    <div class="title-item flex justify-space align-center">
                                                    ...
                                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius
                                                        mauris vitae, tincidunt augue. Sed consectetur magna elit, sit
                                                        amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam
                                                        sit amet neque vestibulum, fringilla
                                            ...
                                            <li class="flex">
                                                <div class="images flex-none">
                                                    <img src="assets/images/author/author-review-3.jpg"
                                                        alt="images">
                                                </div>
                                                <div class="content">
                                                    <div class="title-item flex justify-space align-center">
                                                    ...
                                                    <p class="texts text-color-2">Donec iaculis id nibh vitae
                                                        consequat. Curabitur a molestie odio, id varius odio.
                                                        Suspendisse sollicitudin egestas sodales. Nam semper lorem
                                                        euismod molestie tempus.</p>
                                                    <div class="icon-box flex">
                                                        <a class="icon flex align-center">
                                                            <svg width="16" height="15" viewBox="0 0 16 15"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="wrap-contact wrap-form ">
                                    <div class="titles">
                                        ...
                                        <p class="fs-12 lh-18">Your email address will not be published. Required
                                            fields are marked *</p>
                                    </div>
                                    ...
                                    <div class="widget widget-listings style">
                                        ...
                                        <div class="box-listings flex hover-img3">
                                            <div class="img-listings img-style3">
                                                <img src="assets/images/img-box/sidebar-listings-1.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                                <a class="fs-16 lh-24" href="{{ route('property') }}">Gorgeous
                                        ...
                                        <div class="box-listings flex hover-img3">
                                            <div class="img-listings img-style3">
                                                <img src="assets/images/img-box/sidebar-listings-2.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                                <a class="fs-16 lh-24" href="{{ route('property') }}">Gorgeous
                                        ...
                                        <div class="box-listings flex hover-img3">
                                            <div class="img-listings img-style3">
                                                <img src="assets/images/img-box/sidebar-listings-3.jpg"
                                                    alt="images">
                                            </div>
                                            <div class="content link-style-1">
                                                <a class="fs-16 lh-24" href="{{ route('property') }}">Gorgeous
                                    ...
                                    <div class="widget widget-estate">
                                        ...
                                        <ul class="group-estate flex">
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="{{ route('propertyMap') }}">Moncton</a> </div>
                                            ...
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="{{ route('propertyMap') }}">Mississauga</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="{{ route('propertyMap') }}">Halifax</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="{{ route('propertyMap') }}">Ottawa</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="{{ route('propertyMap') }}">Iqaluit</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                            <li class="box-estate hover-img2">
                                                ...
                                                <div class="content">
                                                    <div class="title link-style-3 fw-6 lh-18"><a
                                                            href="{{ route('propertyMap') }}">Toronto</a> </div>
                                                    <p class="fs-12 lh-16 text-color-1">1570 listing</p>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="widget widget-ads">
                                        <div class="box-ads">
                                            <div class="content relative z-2">
                                                <h3 class="link-style-3"><a href="{{ route('property') }}">Gorgeous
                                                        Apartment Building</a> </h3>
                                                <div class="text-addres ">
                                                    <p class="p-12 text-color-1 icon-p">58 Hullbrook Road, Billesley,
                                                        B13 0LA</p>
                                                </div>
                                                <div class="star flex">
                                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"

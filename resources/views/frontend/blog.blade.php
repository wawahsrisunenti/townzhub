                                    ...
                                    <div class="box-heading ">
                                        <div class="image relative ">
                                            ...
                                            <div class="sub-box flex align-center fs-13 fw-6">
                                                <div class="title-1">April</div><a
                                                    class="title-2 text-color-3">Housing</a>
                                            </div>
                                        </div>
                                        <div class="contents center">
                                            <div class="title-heading fs-30 fw-7 lh-45">Real estate shifts: Prices and
                                                sales trending down in two different spheres</div>
                                            <h4 class="fw-4">Hosted by Brian Sullivan, “Last Call” is a fast-paced,
                                                entertaining business show that explores the intersection of money,
                                                culture and policy. Tune in Monday through Friday at 7 p.m. ET on...
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="wrap-blog ">
                                        <div class="box hover-img flex">
                                            <div class="images img-style relative flex-none">
                                                ...
                                                <div class="sub-box flex align-center justify-space fs-13 fw-6">
                                                    <div class="title-1">January 30</div><a
                                                        class="title-2 text-color-3">Housing</a>
                                                </div>
                                            </div>
                                            <div class="content">
                                                <h3><a href="{{ route('blogDetail') }}">We are hiring ‘moderately,’
                                                        says Compass
                                                        CEO</a></h3>
                                                <p class="text-color-2">Hosted by Brian Sullivan, “Last Call” is a
                                                    fast-paced, entertaining business show that explores the
                                                    intersection of money...</p>
                                                <div class="meta">
                                                    <a href="{{ route('blogDetail') }}"
                                                        class="btn-button flex align-center fs-13 fw-6 text-color-3"><span>Read
                                                            more </span>

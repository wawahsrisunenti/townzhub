                            ...
                            <div class="col-lg-12">
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="index.blade.php"><img src="assets/images/logo/logo@2x.png" alt="" width="197" height="48"></a></div>
                                    </div>
                                            ...
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul class="navigation clearfix">
                                                    <li class="dropdown2 current"><a href="#">Home</a>
                                                        <ul>
                                                            <li class="current"><a href="index.blade.php">Home Page 01</a></li>
                                                            <li><a href="{{ route('home02') }}">Home Page 02</a></li>
                                                            <li><a href="{{ route('home03') }}">Home Page 03</a></li>
                                                            <li><a href="{{ route('home04') }}">Home Page 04</a></li>
                                                            <li><a href="{{ route('home05') }}">Home Page 05</a></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li class="dropdown2"><a href="#">Page</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2"><a href="#">Agents</a>
                                                                <ul>
                                                                    <li><a href="agents.blade.php">Agents</a></li>
                                                                    <li><a href="agents-detail.blade.php">Agents Details</a></li>
                                                                    <li><a href="agents-sidebar-v1.blade.php">Agents Sidebar V1</a></li>
                                                                    <li><a href="agents-sidebar-v2.blade.php">Agents Sidebar V2</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="dropdown2"><a href="#">Agencies</a>
                                                                <ul>
                                                                    <li><a href="agencies.blade.php">Agencies</a></li>
                                                                    <li><a href="agencies-detail.blade.php">Agencies Detail</a></li>
                                                                    <li><a href="agencies-sidebar-v1.blade.php">Agencies Sidebar V1</a></li>
                                                                    <li><a href="agencies-sidebar-v2.blade.php">Agencies Sidebar V2</a></li>
                                                                </ul>
                                                            </li>
                                                    ...
                                                    <li class="dropdown2"><a href="#">Blog</a>
                                                        <ul>
                                                            ...
                                                            <li><a href="blog-detail.blade.php">Blog Detail</a></li>
                                                        </ul>
                                                    </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="content po-content-two">
                                    <div class="heading">
                                        <h1 class="wow slideInDown js-letters" data-wow-delay="0ms" data-wow-duration="1200ms">We will find a perfect home for you</h1>
                                        <p class="fs-16 lh-24 text-color-2 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="2000ms">Find a variety of properties that suit you very easily, forget all difficulties in finding a residence for you</p>
                                    </div>
        ...
        <section class="flat-service tf-section">
            ...
            <div class="widget-bottom-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="title-bottom center"> Copyright © 2024. Designed & Developed by <a href="" class="text-color-1">TOWNZHUB</a> </div>
                        </div>
                    </div>
                </div>
            </div>
